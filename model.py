...
def phishtank_search(url):
    ...
    try:
        ...
        headers = {
            "Content-Type": "application/x-www-form-urlencoded",  # Assuming you are sending form data
            "Accept": "application/json",  # Specify that you want JSON response
        }

        endpoint = "https://checkurl.phishtank.com/checkurl/"
        response = requests.post(endpoint, data={"url": url, "format": "json"}, headers=headers)
        ...
        if response.status_code == 200:
            ...
            if 'results' in data and 'valid' in data['results'] and data['results']['valid'] == True:
